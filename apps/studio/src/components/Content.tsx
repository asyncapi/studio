...
export const Content: FunctionComponent<ContentProps> = () => { // eslint-disable-line sonarjs/cognitive-complexity
  ...
  const [localStorageLeftPaneSize, setLocalStorageLeftPaneSize] = useState(220);
  ...
  //   setLocalStorageLeftPaneSize(localStorageLeftPaneSize);
  //   setLocalStorageRightPaneSize(localStorageRightPaneSize);
  // }, []);
