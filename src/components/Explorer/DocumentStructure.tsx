...
const ServersDocumentStructure: FunctionComponent<DocumentStructureSectionProps> = ({
  document,
  hash,
}) => {
...
const OperationsDocumentStructure: FunctionComponent<DocumentStructureSectionProps> = ({
  document,
  hash,
}) => {
  const { navigationSvc } = useServices();
...
const MessagesDocumentStructure: FunctionComponent<DocumentStructureSectionProps> = ({
  document,
  hash,
}) => {
  const { navigationSvc } = useServices();
...
const SchemasDocumentStructure: FunctionComponent<DocumentStructureSectionProps> = ({
  document,
  hash,
}) => {
  const { navigationSvc } = useServices();
...
export const DocumentStructureContent: FunctionComponent<DocumentStructureProps> = ({
  className = '',
}) => {
...
export const DocumentStructure: FunctionComponent = () => {
  return (
    <div>
      <ExpandedPanel title='Document structure' expanded={true}>
