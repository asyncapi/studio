                  ...
                  <div key={index}>
                    ...
                    { selectedOrg == org.id && (
                      <div className="pl-4">
                        ...
                        { featureFlags.enableDeveloperPortal && (<a href={`/settings/organizations/${org.id}/developer-portal`} className={`block truncate px-3 py-1 text-sm leading-5 text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-100 transition ease-in-out duration-150 ${selectedSection === 'developer-portal' ? 'font-bold' : 'font-normal'}`}>Developer portal</a>) }
